...
namespace Classes.ClassTypes4
{
    internal class YariZamanliPersonel: Personel
    {
        ...
        //void YariZamanliPersonelEkle(List<Personel> personeller)
        //{
        //    Console.Write("Ad: ");
        //    string ad = Console.ReadLine();
        //    Console.Write("Soyad: ");
        ...
        //    Console.Write("Saat Ücret: ");
        //    decimal saatUcret = Convert.ToDecimal(Console.ReadLine());
        //    Console.Write("Yaptığı Satış Tutarı: ");
        //    decimal satisTutari = Convert.ToDecimal(Console.ReadLine());
        //    YariZamanliPersonel yariZamanli = new YariZamanliPersonel(ad, soyad, calismaSaati, saatUcret, satisTutari);
        //    personeller.Add(yariZamanli);
        //    Console.WriteLine("Yarı zamanlı personel eklendi.");
        //}
    }
