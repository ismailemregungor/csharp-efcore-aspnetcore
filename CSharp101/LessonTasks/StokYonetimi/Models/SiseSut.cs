...
{
    public class SiseSut : Urun, IKirilabilir, IBozulabilir, ISonKullanimTarihiGecebilir, IDeformeOlabilir
    {
        public DateTime SonKullanimTarihi { get; set; }
        public SiseSut(DateTime SonKullanimTarihi, int urunId, string urunAdi) : base(urunId, urunAdi)
        {
